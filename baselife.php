...
<head>
    ...
    <title>Base Life Support Services | Golden Lines Company</title>
    ...
    <style>
        /* Hero Section */
        .hero {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('images/base.jpg') no-repeat center center/cover;
